...
A **general**-family positive benchmark from the `examples2` corpus (`Trigger_Activated_PingPong_Composition.rebeca`), integrated without adaptation.

## Provenance

### 1. Original purpose

Two actors bounce a message back and forth after one constructor fires: the smallest trigger-activated composition.
