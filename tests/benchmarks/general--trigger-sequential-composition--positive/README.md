...
A line of four actors with first and last roles marked, message servers ranked by priority, and the last node looping back to itself so the sequence repeats.
