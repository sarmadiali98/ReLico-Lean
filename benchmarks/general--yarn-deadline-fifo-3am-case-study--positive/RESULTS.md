# Results - `general--yarn-deadline-fifo-3am-case-study--positive`
...
| model checker | RMC 2.14, `Deadlock-Freedom and No Deadline Missed` | **`satisfied`** (541,164 states, 1,850,284 transitions) |
...
`manifest.json`. Generated C++ compilation emitted warnings only.
