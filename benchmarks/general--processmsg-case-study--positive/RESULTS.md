# Results - `general--processmsg-case-study--positive`
...
| model checker | RMC 2.14, `Deadlock-Freedom and No Deadline Missed` | **`satisfied`** (6 states, 7 transitions) |
...
The fixture source is byte-identical to `examples.zip:ReLico-main/ProcessMsg/ProcessMsg.rebeca`.
`ProcessMsg.property` is intentionally excluded. All eight expected artifacts were copied from the
