# Results — `general--tinyosmacb-case-study--positive`

Measured 2026-09-08. The stage results were confirmed both through the pipeline's stage tool and through the benchmark runner's pinned bootstrap below.
