# Results - `general--yarn-deadline-fifo-2am-case-study--positive`
...
| model checker | RMC 2.14, `Deadlock-Freedom and No Deadline Missed` | **`satisfied`** (10,919 states, 27,886 transitions) |
