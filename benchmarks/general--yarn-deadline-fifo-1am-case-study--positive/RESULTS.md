# Results - `general--yarn-deadline-fifo-1am-case-study--positive`
...
| model checker | RMC 2.14, `Deadlock-Freedom and No Deadline Missed` | **`satisfied`** (236 states, 412 transitions) |
...
All eight expected artifacts were copied from the successful pipeline outputs and SHA-256-pinned in
`manifest.json`. The generated C++ compiler emitted only extraneous-parentheses warnings.
