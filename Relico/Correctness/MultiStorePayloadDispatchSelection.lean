...
-/
theorem multiStorePayloadBase_targetTag_eq_of_sameSource
...
-/
theorem multiStorePayloadBase_reactionPriorityEligible_of_sameSource
    {messageServers : List DTR.MultiStorePayloadMessageServer}
    {sourceBag : DTR.MessageBag}
    {targetQueue : LF.ActionQueue}
    {sourceMessage : DTR.PendingMessage}
...
-/
theorem multiStorePayload_sourceDispatchSelection
    {messageServers : List DTR.MultiStorePayloadMessageServer}
  ...
  obtain
    ⟨targetSelected,
     ...
     hRemainingCompatible⟩ :=
      MultiStorePayloadSelectionCompatible.remove_source
        hCompatible
        hRemoved
  ...
  have hTargetSelectedEligible :
      LF.MultiStorePayloadIsReactionPriorityEligible
        ...
        targetSelected
        targetQueue :=
    multiStorePayloadBase_reactionPriorityEligible_of_sameSource
      hBaseCompatible
...
-/
theorem multiStorePayload_targetDispatchSelection
    {messageServers : List DTR.MultiStorePayloadMessageServer}
    {sourceBag : DTR.MessageBag}
  ...
  obtain
    ⟨sourceSelected,
     ...
     hSelectedPayload,
     hRemainingCompatible⟩ :=
      MultiStorePayloadSelectionCompatible.remove_target
        hCompatible
        hRemoved
