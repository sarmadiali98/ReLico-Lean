...
-/
def DirectLFStrictPriorityPrecedes
...
theorem DirectLFStrictPriorityPrecedes.precedes
    {messageServers : List DTR.MessageServer}
    {left right : MsgName}
    (hStrict :
...
theorem DirectLFStrictPriorityPrecedes.not_reverse
    {messageServers : List DTR.MessageServer}
    {left right : MsgName}
    (hStrict :
      DirectLFStrictPriorityPrecedes
...
-/
def DirectLFPairSelectionCompatible
    (messageServers : List DTR.MessageServer)
...
theorem DirectLFPairSelectionCompatible.leftCorresponds
    {messageServers : List DTR.MessageServer}
    {sourceLeft sourceRight : DTR.PendingMessage}
    {targetLeft targetRight : LF.PendingAction}
    (hCompatible :
...
theorem DirectLFPairSelectionCompatible.rightCorresponds
    {messageServers : List DTR.MessageServer}
    {sourceLeft sourceRight : DTR.PendingMessage}
    {targetLeft targetRight : LF.PendingAction}
    (hCompatible :
...
theorem DirectLFPairSelectionCompatible.symm
    {messageServers : List DTR.MessageServer}
    {sourceLeft sourceRight : DTR.PendingMessage}
    {targetLeft targetRight : LF.PendingAction}
    (hCompatible :
...
theorem directLFPairSelectionCompatible_of_differentTime
    {messageServers : List DTR.MessageServer}
    {sourceLeft sourceRight : DTR.PendingMessage}
    {targetLeft targetRight : LF.PendingAction}
    (hLeft :
...
theorem directLFPairSelectionCompatible_of_sameMicrostep
    {messageServers : List DTR.MessageServer}
    {sourceLeft sourceRight : DTR.PendingMessage}
    {targetLeft targetRight : LF.PendingAction}
    (hLeft :
...
theorem directLFPairSelectionCompatible_of_leftEarlier
    {messageServers : List DTR.MessageServer}
    {sourceLeft sourceRight : DTR.PendingMessage}
    {targetLeft targetRight : LF.PendingAction}
    (hLeft :
...
theorem DirectLFPairSelectionCompatible.strictPriority_of_leftEarlier
    {messageServers : List DTR.MessageServer}
    {sourceLeft sourceRight : DTR.PendingMessage}
    {targetLeft targetRight : LF.PendingAction}
    (hCompatible :
...
theorem DirectLFPairSelectionCompatible.strictPriority_of_rightEarlier
    {messageServers : List DTR.MessageServer}
    {sourceLeft sourceRight : DTR.PendingMessage}
    {targetLeft targetRight : LF.PendingAction}
    (hCompatible :
...
-/
inductive DirectLFAlignedOccurrence
...
theorem DirectLFAlignedOccurrence.pendingCorresponds
    {sourceMessage : DTR.PendingMessage}
    {targetAction : LF.PendingAction}
...
theorem DirectLFAlignedOccurrence.source_mem
    {sourceMessage : DTR.PendingMessage}
    {targetAction : LF.PendingAction}
    {sourceQueue : DTR.MessageBag}
    {targetQueue : LF.ActionQueue}
...
theorem DirectLFAlignedOccurrence.target_mem
    {sourceMessage : DTR.PendingMessage}
    {targetAction : LF.PendingAction}
    {sourceQueue : DTR.MessageBag}
    {targetQueue : LF.ActionQueue}
...
-/
structure DirectLFOrderedSelectionCompatible
    (messageServers : List DTR.MessageServer)
...
-/
def DirectLFSelectionCompatible
    (messageServers : List DTR.MessageServer)
    (sourceQueue : DTR.MessageBag)
    (targetQueue : LF.ActionQueue) :
    Prop :=
...
correspondence.
-/
theorem DirectLFSelectionCompatible.toBagQueueCorresponds
    {messageServers : List DTR.MessageServer}
    {sourceQueue : DTR.MessageBag}
    {targetQueue : LF.ActionQueue}
    (hCompatible :
...
-/
theorem directLFSelectionCompatible_nil
    (messageServers : List DTR.MessageServer) :
    DirectLFSelectionCompatible
      messageServers
      []
...
fact.
-/
theorem directLFAlignedOccurrence_of_source_mem
    {sourceQueue : DTR.MessageBag}
    {targetQueue : LF.ActionQueue}
    (hQueues :
      Correctness.QueueCorresponds
...
occurrence.
-/
theorem directLFAlignedOccurrence_of_target_mem
    {sourceQueue : DTR.MessageBag}
    {targetQueue : LF.ActionQueue}
    (hQueues :
      Correctness.QueueCorresponds
...
theorem
  ...
  obtain
    ⟨targetSelected,
     hSelectedAligned⟩ :=
      directLFAlignedOccurrence_of_source_mem
        hOrdered.queues
