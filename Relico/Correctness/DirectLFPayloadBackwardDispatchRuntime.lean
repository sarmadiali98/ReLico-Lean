...
Payload-refined backward dispatch simulation for the direct DTR-to-generated-LF
translation.
...
-/
@[simp]
theorem directLFPayload_compileBody_eq_nil_iff
    (sourceBody : DTR.Body) :
...
not required.
-/
theorem directLFPayload_multiStore_dispatch_backward_runtime
    {messageServers :
  ...
  | fire
      ...
      | mk
          ...
          obtain
            ⟨selectedMessage,
             ...
             hRemainingCompatible⟩ :=
              directLFPayload_targetDispatchSelection
                hCompatible
                hTargetRemoved
                hTargetPriorityEligible
          ...
          have hSourceBodyEmpty :
              sourceActiveBody =
                [] :=
            (directLFPayload_compileBody_eq_nil_iff
              sourceActiveBody).mp
