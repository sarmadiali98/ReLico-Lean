...
Payload-refined forward dispatch simulation for the direct DTR-to-generated-LF
translation.
...
-/
theorem directLFPayload_multiStore_dispatch_forward_runtime
    {messageServers :
      ...
      obtain
        ⟨selectedAction,
         ...
         hRemainingCompatible⟩ :=
          directLFPayload_sourceDispatchSelection
