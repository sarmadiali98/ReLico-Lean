...
EXPORTER_SOURCE="$REPOSITORY_ROOT/frontend/java-bridge/RebecaMultiStoreJsonExporter.java"
...
cp \
  "$EXPORTER_SOURCE" \
  "$EXPORTER_DIRECTORY/RebecaMultiStoreJsonExporter.java"
...
(
  ...
  "$MAVEN_BIN" \
    ...
    -Dexec.mainClass=org.rebecalang.compiler.frontendbridge.RebecaMultiStoreJsonExporter \
