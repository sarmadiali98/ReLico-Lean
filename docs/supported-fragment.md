...
a typed DTR AST;
a typed generated-LF AST;
a source well-formedness definition or checker;
an executable Lean translation function;
DTR operational semantics;
generated-LF operational semantics;
a source-target state correspondence relation;
a forward simulation theorem;
a backward simulation theorem;
an end-to-end compiler correctness theorem about the executable translation function;
no sorry, admit or project-specific axioms in the final theorem dependency.
